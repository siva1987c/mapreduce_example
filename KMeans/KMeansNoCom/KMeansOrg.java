...
public class KMeansOrg extends Configured implements Tool{
	static String[] centerPoints = new String[8] ;
	public static class Map extends MapReduceBase implements Mapper<LongWritable, Text, Text, Text> {
		public void configure(JobConf conf) {
			try{
				FileSystem dfs = FileSystem.get(conf);	
				String location = "topToRegionFile";
	...
	public int run(String[] args) throws Exception {
		...
		JobConf jobf = new JobConf(getConf(),KMeansOrg.class);
		jobf.setJobName("KMeansOrg");
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new KMeansOrg(), args);
		System.exit(res);
	}
}
